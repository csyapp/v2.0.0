...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CARTE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CARTE actions', async () => {
      const arg = { matricule: 'CBA' };
    ...
    it('dispatches UPDATE_CARTE actions', async () => {
      const arg = { matricule: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_CARTE actions', async () => {
      const arg = { matricule: 'ABC' };
    ...
    it('dispatches DELETE_CARTE actions', async () => {
      const arg = 42666;
