...
import { getReportingAnnee } from 'app/entities/reporting/reporting-annee-suffix.reducer';
...
export const YearsPage = () => {
  ...
  const reportingList = useAppSelector(state => state.reportingAnnee.entities);
